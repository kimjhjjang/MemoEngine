    ...
    <ItemTemplate>
        <tr style="border-bottom: 1px dotted silver;">
            ...
            <td style="width: 350px;">
                <%# MemoEngine.Answers.HtmlUtility.Encode(Eval("Opinion").ToString()) %>
            </td>
            <td style="width: 180px;">
                <%# Eval("PostDate") %>
            </td>
            <td style="width: 10px; text-align: center;">
                <a href='AnswerCommentDelete.aspx?ArticleId=<%= Request["Id"] %>&Id=<%# Eval("Id") %>' title="댓글 삭제">
    ...
    <tr>
        ...
        <td style="width: 128px;">
            <asp:TextBox ID="txtPassword" runat="server" 
                TextMode="Password" Width="128px" CssClass="form-control" Style="display: inline-block;"></asp:TextBox>
        </td>
        <td style="width: 128px; text-align: right;">
            <asp:Button ID="btnWriteComment" runat="server" Text="의견남기기" Width="96px" CssClass="form-control btn btn-primary" 
                Style="display: inline-block;" OnClick="btnWriteComment_Click" />
        </td>
    </tr>
    <tr>
        <td style="width: 64px; text-align: right;">의 견 : </td>
        <td colspan="4" style="width: 448px;">
            <asp:TextBox ID="txtOpinion" runat="server" TextMode="MultiLine" Rows="3" Columns="70" Width="448px" CssClass="form-control" 
